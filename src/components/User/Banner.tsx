  ...
  return (
    <>
     <div className="relative z-20 h-35 md:h-65">
        ...
        <div className="px-4 pb-4 text-center flex items-center justify-center flex-wrap md:flex-nowrap md:justify-between">
        ...
        <div className="relative z-30 -mt-10 h-30 w-full max-w-30 rounded-full bg-white dark:bg-black p-1 backdrop-blur sm:h-40 sm:max-w-40 sm:p-2">
         ...
         <div className="flex items-center">
                      <h4 className="text-lg font-semibold text-black dark:text-white">Miracle</h4>
                      <MdVerified className="text-lg text-blue-700 ms-1" />
                    </div>
                    <div>
                        <span className="text-base text-gray-800 dark:text-gray-300"><b className="font-semibold">12.K</b> followers</span>
                    </div>
         </div>
        </div>
       <div className="flex items-center">
    <Link href={"account/edit"}>   <button type="button" className="text-white bg-blue-600 hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-full text-sm px-7 py-3 text-center me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Edit Profile</button></Link>
       </div>
        </div>
    </>
  );
